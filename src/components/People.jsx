...
import { faHeart, faQuoteLeft, faQuoteRight, faUserGraduate } from '@fortawesome/free-solid-svg-icons'
...
const People = () => {
  ...
  return (
    <section className=' relative w-full flex items-center justify-center flex-col my-8'>
      ...
      <div className='z-30 w-full flex items-center justify-center py-7 pb-11 text-slate-700 dark:text-slate-100 text-2xl font-bold px-3'>
        <FontAwesomeIcon className='px-2 text-red-600 text-3xl' icon={faHeart} />
        Love from some students
      </div>
      <main className='w-[85%] sm:w-[65%] md:w-[85%] max-[767px]:w-[70%] h-auto p-2 xl:w-[95%] flex items-center justify-center gap-4 flex-col xl:flex-row'>
        <div className=' w-full flex items-center justify-center gap-5 flex-col xl:flex-row'>
          <div className=' w-auto flex items-center justify-center flex-col md:flex-row gap-5'>
            <div className=' cardNormall p-5 w-auto h-auto bg-[rgba(241,245,249,.3)]  shadow-xl dark:bg-[rgba(30,41,59,.5)] backdrop-blur-md rounded-xl flex items-center justify-center flex-col'>
              <div className=' w-full flex items-center justify-start'>
                <img src={sakaba} loading='lazy' className='w-16 h-16 rounded-full shrink-0 mr-3' />
                <div className=' w-full flex items-start justify-center flex-col'>
                  <h3 className=' font-mmedium text-md text-slate-800 dark:text-slate-50'>
                    <FontAwesomeIcon className='px-2' icon={faUserGraduate} />
                    Anas Sakaba
                  </h3>
                  <p className='text-[13px] text-slate-600 dark:text-slate-300 pt-1 ml-1'>
                    Computer Science
                  </p>
                </div>
              </div>
              <div className='mt-2 p-1 dark:text-slate-200 text-slate-800'>
                ...
                Anas Sakaba here, I can't stress enough how crucial the PQ Hub has been to my academic journey.
            ...
            <div className=' cardNormall p-5 w-auto h-auto bg-[rgba(241,245,249,.3)]  shadow-xl dark:bg-[rgba(30,41,59,.5)] backdrop-blur-md rounded-xl flex items-center justify-center flex-col'>
              <div className=' w-full flex items-center justify-start'>
                <img src={classrep} loading='lazy' className='w-16 h-16 rounded-full shrink-0 mr-3' />
                <div className=' w-full flex items-start justify-center flex-col'>
                  <h3 className=' font-mmedium text-md text-slate-800 dark:text-slate-50 '>
                    <FontAwesomeIcon className='px-2' icon={faUserGraduate} />
                    Mustee
              ...
              <div className='mt-2 p-1 dark:text-slate-200 text-slate-800'>
                <FontAwesomeIcon icon={faQuoteLeft} className='text-2xl text-blue-500 pr-1' />
                The PQ Hub transformed my study routine. Past questions are
                now at my fingertips, making my preparation targeted and efficient.
                <FontAwesomeIcon className='text-2xl text-blue-500 pl-1' icon={faQuoteRight} />
              </div>
            </div>
          </div>
          <div className=' w-auto h-auto transform flex flex-col items-center justify-center md:flex-row gap-5'>
            <div className=' cardNormalr p-5 w-auto h-auto bg-[rgba(241,245,249,.3)]  shadow-xl dark:bg-[rgba(30,41,59,.5)] backdrop-blur-md rounded-xl flex items-center justify-center flex-col'>
              <div className=' w-full flex items-center justify-start'>
                <img src={bena} loading='lazy' className='w-16 h-16 rounded-full shrink-0 mr-3' />
                <div className=' w-full flex items-start justify-center flex-col'>
                  <h3 className=' font-mmedium text-md text-slate-800 dark:text-slate-50 '>
                    <FontAwesomeIcon className='px-2' icon={faUserGraduate} />
                    Abbaty Bena
            ...
            <div className=' cardNormalr p-5 w-auto h-auto bg-[rgba(241,245,249,.3)]  shadow-xl dark:bg-[rgba(30,41,59,.5)] backdrop-blur-md rounded-xl flex items-center justify-center flex-col'>
              <div className=' w-full flex items-center justify-start'>
                <img src={blaba} loading='lazy' className='w-16 h-16 rounded-full shrink-0 mr-3' />
                <div className=' w-full flex items-start justify-center flex-col'>
                  <h3 className=' font-mmedium text-md text-slate-800 dark:text-slate-50 '>
                    <FontAwesomeIcon className='px-2' icon={faUserGraduate} />
                    Lois Olamide
